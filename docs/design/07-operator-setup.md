...
2. Insert `missions` with `group_id`, `access_rule`, `completion_data`, `brief_markdown`, `debrief_markdown`, `title` (author in **radspion-missions**, then run `scripts/generate_storyline_sql.py`)  
